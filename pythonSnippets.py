...
#Augment your images and according masks for deep learning application. Here both original image and corresponding mask are augmented with a same functions
import Augmentor
import numpy as np
